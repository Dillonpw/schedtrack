...
export default function Privacy() {
  return (
    <main>
      <Header />
      <h1 className="mt-10 text-center text-2xl font-bold text-red-600/80">Privacy Policy</h1>
      <div className="mx-auto max-w-[40%]">
        <p className="mx-10 mt-10 text-xl">
          Your privacy is important to us. It is Sched Track's policy to respect
          your privacy regarding any information we may collect from you across
          our website, and other sites we own and operate. We only ask for
          ...
          be used. You can sign up with your Google account so your Sched Track
          account username will be prefilled with your name and your public
          profile picture. We only retain collected information for as long as
          ...
          information publicly or with third parties, except when required to by
          law.
          <br />
          <br />
          Third-party vendors, including Google, use cookies to serve ads based
          on a user's prior visits to your website or other websites. Google's
          use of advertising cookies enables it and its partners to serve ads to
          your users based on their visit to your sites and/or other sites on
          the Internet. Users may opt out of personalized advertising by
          visiting Ads Settings, or visiting{" "}
          <a href="https://www.aboutads.info">www.aboutads.info</a>.
          <br />
          <br /> Our website may link to external sites that are not operated by
